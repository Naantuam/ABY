          ...
          <div className="bg-white w-full rounded-t-3xl p-6 max-h-[90vh] overflow-y-auto relative z-10 animate-in slide-in-from-bottom duration-300">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={items.find(it => it.id === editingRowId)?.name || ""}
                  onChange={(e) => handleFieldChange(editingRowId, "name", e.target.value)}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={items.find(it => it.id === editingRowId)?.category || ""}
                  onChange={(e) => handleFieldChange(editingRowId, "category", e.target.value)}
                  className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={items.find(it => it.id === editingRowId)?.quantity || 0}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={items.find(it => it.id === editingRowId)?.unit || ""}
                    onChange={(e) => handleFieldChange(editingRowId, "unit", e.target.value)}
                    className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                  />
                </div>
              </div>
              ...
              {/* Last Updated */}
              <div>
                <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Last Updated</label>
                <input
                  type="date"
                  value={items.find(it => it.id === editingRowId)?.lastUpdated || ""}
                  onChange={(e) => handleFieldChange(editingRowId, "lastUpdated", e.target.value)}
                  className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                />
              </div>
