    ...
    <div className="p-0 sm:p-6 bg-gray-50 min-h-screen font-sans">
      ...
      {editingRowId && originalItem && (
        <div className="fixed inset-0 z-50 flex items-end justify-center lg:hidden">
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm" onClick={() => { setEditingRowId(null); setOriginalItem(null); fetchOperations(); }} />
          <div className="bg-white w-full rounded-t-3xl p-6 max-h-[90vh] overflow-y-auto relative z-10 animate-in slide-in-from-bottom duration-300">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-gray-900">Edit Operation</h3>
              <button onClick={() => { setEditingRowId(null); setOriginalItem(null); fetchOperations(); }} className="p-2 bg-gray-100 rounded-full text-gray-500">
                <X className="w-5 h-5" />
              </button>
            </div>
